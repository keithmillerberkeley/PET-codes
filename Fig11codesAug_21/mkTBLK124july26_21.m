 ...
 %  file mkTBLK124july26_21.m  (was mkTBLK124jan17_21.m (was mkTBLK124jan6_21.m  (was mkTBLK124oct2_20.m  (was mkTBLK124aug14_20.m  (was mkTBLK124may5_20.m   ( was mkTBLK124mar31.m)
...
%    We begin the TBLK computation  for f124fill
   ...
   global yy2;      % Ny1XNy2
   global PHIBMAX;
   global R12 R24 R1t fac; % from TBLK124
...
%  Nphi =040;
   ...
   Ny1 = 025; % temporary for small TBLK
   Ny2 = 025; 
   Nphi =011;
   ...
   PHIBMAX = atan(15/40)
   R12=8    % trials with R=8 TOFu=10 PHIBMAX=atan(15/40)=.35877 Jan17_21
   R24=16
   fac = .8300 % tuned for TOFu=10 See july15_21 NOTES

%  PHIBMAX = atan(.8*15/40)
%  R12=8
%  R24=16
%  fac = .8200  % tuned for TOFu=10 See july15_21 NOTES
...
%  TBLK24tt = 0.5*(1-sign(-R24 -.000001 +rrr )).*(TBLK2 -fac*TBLK4);  % we cutoff at radius R24
   ...
   TBLK1t = 0.5*(1-erf(.5*(-R1t -.000001 +rrr ))).*TBLK1;  % we FEATHER cutoff at radius >R1t
   TBLK12t = 0.5*(1-erf(.5*(-R12 -.000001 +rrr ))).*(TBLK1 -fac*TBLK2);  % we cutoff at radius R12
