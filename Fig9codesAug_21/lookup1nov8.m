   ...
   %  called from randPET3D.m
    ...
    function Hts = lookup1nov8(phi)  % I passed syy1 syy2 as globals
...
%   u33  = 1- sqrt(1-(phi/PHIBMAX)^2); % index in [0,1), %  ERROR dtected july3_21
...
%   maxmaxsliceTBLK1 = max(max(slice))    % print
