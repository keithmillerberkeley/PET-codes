...
%%-----------------------------------------------------------------
       ...
       function HH = vecHH4aug20(phi,phib)
...
%     tt = .5*tt;   % sep19-17 Aug3_19 this gives blur radius 2.0
%     ss = .5*ss;   % MAY9_18
 
      tt = .25*tt;   % sep19-17 Aug15_19 this gives blur radius 4.0
      ss = .25*ss;   % MAY9_18
...
%    clear Htt Hts2    % clear these large matrices
%========================================================
