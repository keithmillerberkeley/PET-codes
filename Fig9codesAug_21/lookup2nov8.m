   ...
   %  called from randPET3D.m
    ...
    function Hts = lookup2nov8(phi)  % I passed syy1 syy2 as globals
...
% We TESTED already in onebeam that abs(phi) < PHIBMAX
 ...
 global PHIBMAX;  % max phib (angle from equator) of our kernel
   ...
   global TBLK1 TBLK12t TBLK24tt TBLK24t TBLK4 TBLK2
   global R12 R24 RTOF;
   global RG12 RG24 Cut4;
...
%   u33  = 1- sqrt(1-(phi/PHIBMAX)^2); % index in [0,1), ERROR detected july3_21
 ...
 f33 = 1+f33 ;               % Thus f3+1 is in [2,Nphi]
    ...
    slice = (1-r33)*TBLK2(:,:,f33) + r33*TBLK2(:,:,1+f33);                ;
