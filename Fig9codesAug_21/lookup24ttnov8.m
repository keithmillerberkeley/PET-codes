   ...
   %  called from randPET3D.m
    ...
    function Hts = lookup24ttnov8(phi)  % I passed syy1 syy2 as globals
...
%   u33  = 1- sqrt(1-(phi/PHIBMAX)^2); % index in [0,1), ERROR detected july3_21
 ...
 f33 = 1+f33 ;               % Thus f3+1 is in [2,Nphi]
    ...
    slice = (1-r33)*TBLK24tt(:,:,f33) + r33*TBLK24tt(:,:,1+f33);                ;
...
%    RG24 = 2.0*RTOF + 1.25*R24;
     Hts = (0.5*(1-sign(-RG24+abs(syy0)))).*Hts;
