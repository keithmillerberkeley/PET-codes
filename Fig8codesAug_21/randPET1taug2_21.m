...
%  TOFu = 00   % Print TEMPOR 

   R1t = R1t    % =20 from MKTBLK July7_21
   TOFu = 10   % Print TEMPOR july19_21
...
%======================================================
      ...
      Nxx = 24;Nyy = 24; Nzz = 24;  %  Aug2_21
%     Nxx = 38;Nyy = 38; Nzz = 00;  % July6_21 and July19_21 andAug2_21
%     Nxx = 38;Nyy = 38; Nzz = 05;  % July6_21 
...
%   dxx = 0.5;  dyy = 0.5;  dzz = 0.5;
    dxx = 0.25;  dyy = 0.25;  dzz = 0.25;
...
%  Nsrc = 1.0e6;  % number of random sources to compute
  ...
  aa_bb_cc_Nsrc =  [aa,bb,cc,Nsrc]   % print
   ...
   shift1 = [ 00 -00  00]; % for onebeam4cube %
   shift2 = [ 00  00  00]; % for onebeam4cube %
   shift3 = [ -00 00  00]; % for onebeam4cube %
   shift4 = [ 00  00  -00]; % for onebeam4cube %
