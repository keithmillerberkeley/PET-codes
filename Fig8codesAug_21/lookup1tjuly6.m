...
%    LG1t = 2.0*TOFu + 1.25*L1t; %  LG1t is cutoff for f1t
% Hts = (0.5*(1-erf(-LG1t+abs(syy0)))).*Hts; % Aug3_21 FEATHER the cutoff
  Hts = (0.5*(1-sign(-LG1t+abs(syy0)))).*Hts;
