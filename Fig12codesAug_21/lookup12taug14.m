   ...
   %  called from randPET3D.m
    ...
    function Hts = lookup12taug14(phi)  % I passed syy1 syy2 as globals
...
% We TESTED already in onebeam that abs(phi) < PHIBMAX
 ...
 global PHIBMAX;  % max phib (angle from equator) of our kernel
   ...
   global TBLK1 TBLK1t TBLK12t TBLK24tt TBLK2 TBLK4
   global R12 R24 R1t RTOF;
   global RG12 RG24 RG1t ;
...
%    Hts = (0.5*(1-erf(-RG12+abs(syy0)))).*Hts; % FEATHER the cutoff. July27_21
